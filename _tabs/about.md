...
### CI/CD
`GitHub Actions` `GitLab CI` `Jenkins` `ArgoCD` `Rundeck`

### Containers
`Docker` `Kubernetes (EKS, GKE, self-managed)` `AWS ECS/Fargate`

### Observability
`Prometheus` `Grafana` `Loki` `Tempo` `Cortex` `OpenTelemetry` `Datadog` `ELK Stack` `PMM` `Jaeger`
...
### DevOps Engineer — Mingjaya Sejahtera (ctlyst.id / jamtangan.com / voila.id)
**Sep 2021 – Sep 2023**  
Kubernetes deployments, Terraform infrastructure, security tooling (SonarQube, OWASP), VPN automation, observability integration with data engineering teams.

### Site Reliability Engineer — Fintek Karya Nusantara (LinkAja.id)
**Apr 2020 – Sep 2021**  
Production reliability across AWS EKS + Alibaba Cloud Kubernetes. Incident response, RCA, operational automation (Python/Bash/Ansible/Rundeck).

### System Administrator & Hadoop Administrator — Solusi 247 Co.
**Jul 2017 – Apr 2020**  
Hadoop cluster management (Cloudera/Hortonworks), system performance tuning, ELK logging, Docker stacks, security hardening (Fail2Ban, ModSecurity).

### IT Support Engineer Intern — PD Pasar Resik Kota Tasikmalaya
**Aug 2014 – Feb 2015**  
...
### Crypto Trading Bot
Python-based algorithmic trading with breakout, pullback, scalping, and volume spike strategies. Migrated from Lambda to systemd for latency/cost optimization.
...
**AWS Certified SysOps Administrator – Associate** — Nov 2020  
